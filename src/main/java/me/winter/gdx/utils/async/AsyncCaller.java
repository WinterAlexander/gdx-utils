...
import me.winter.gdx.utils.error.StackTracker;
import me.winter.gdx.utils.error.Tracker;
import me.winter.gdx.utils.log.Logger;
import me.winter.gdx.utils.log.NullLogger;
...
public class AsyncCaller<R> {
	...
	public static void setLogger(Logger logger) {
		AsyncCaller.logger = coalesce(logger, new NullLogger());
	}
