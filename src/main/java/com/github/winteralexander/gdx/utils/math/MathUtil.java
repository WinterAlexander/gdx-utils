package com.github.winteralexander.gdx.utils.math;
...
public class MathUtil {
	                                      ...
	                                      float rectX, float rectY, float width, float height) // rect
	{
		...
		if(inAABB(lineX1, lineY1, rectX, rectY, width, height) || inAABB(lineX2, lineY2, rectX, rectY, width, height))
			return true;
	...
	public static boolean inAABB(Vector2 point, Vector2 startPos, Vector2 size, Vector2 origin) {
		return inAABB(point.x, point.y, startPos.x + origin.x, startPos.y + origin.y, size.x, size.y);
	}

	public static boolean doAABBCollideWithAABB(float x1, float y1, float w1, float h1, float x2, float y2, float w2, float h2) {
		if(x1 + w1 <= x2)
			return false;
	 ...
	 */
	public static boolean isAABBfullyInAABB(float x1, float y1, float w1, float h1, float x2, float y2, float w2, float h2) {
