...
public class RasterizationUtilTest {
	...
	public void testLineRasterization2D() {
		...
		RasterizationUtil.allIntersectingLine2D(0f, 1f, 6f, 4f, out);
		printRaster(out);

		out.clear();
		RasterizationUtil.allIntersectingLine2D(0.111f, 0.3123f, 100.123f, 35.213f, out);
		//System.out.println(ReflectionUtil.toPrettyString(out));
		printRaster(out);

		out.clear();
		RasterizationUtil.allIntersectingLine2D(0.5f, 0.5f, 1.5f, 2.5f, out);
		//System.out.println(ReflectionUtil.toPrettyString(out));
		printRaster(out);
	}
