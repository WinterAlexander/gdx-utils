...
public class BitsetUtilTest {
	...
	public void testBitsetToIntConversion() {
		...
		assertEquals((short)256,
				toShort(false, false, false, false, false, false, false, false, true));
		assertEquals((short)65_535,
				toShort(true,
						true,
						true,
						true,
		...
		assertEquals(65_536,
				toInt(false,
						...
						false,
						true));
		assertEquals((int)4_294_967_295L,
				toInt(true,
						true,
						true,
						true,
		...
		try {
			...
			fail("toShort() did not throw IllegalArgumentException when providing bitset too "
					+ "large");
		} catch(IllegalArgumentException expected) {
		}
